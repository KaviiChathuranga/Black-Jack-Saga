...
//  Win Black Jack Saga
//
//  Created by Treinetic Macbook004 on 10/22/19.
...
extension CustomCode{
    // play sound effects
//    func playSound(type : String){
//        if type == "shuffle"{
//            CustomExtensionStruct.audioFilePath.startOneTimeMusic()
//        }
//        if type == "win"{
//            CustomExtensionStruct.winFilePath.startOneTimeMusic()
//        }
//        if type == "lost"{
//            CustomExtensionStruct.lostFilePath.startOneTimeMusic()
//        }
//        if type == "draw"{
//            CustomExtensionStruct.drawFilePath.startOneTimeMusic()
//        }
//    }
    
    // start timer
    func callTimer(){
        structure.timer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: (#selector(CustomCode.action)), userInfo: nil, repeats: true)
    }
    @objc func action(){
        structure.time -= 1
        if structure.time == 0 {
